...
4. Always implement test cases for the new functionality, ensuring good coverage and following the testing guidelines. Refer to the **test-writer** skill for best practices on writing tests and refer to **test-executor** for running them.

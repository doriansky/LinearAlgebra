...
template Vector::Vector<long double> Matrix<int>::solveLowerTriangular(Vector::Vector<double> const&) const;
template Vector::Vector<long double> Matrix<int>::solveLowerTriangular(Vector::Vector<long double> const&) const;

template Vector::Vector<long double> Matrix<float>::solveLowerTriangular(Vector::Vector<int> const&) const;
template Vector::Vector<long double> Matrix<float>::solveLowerTriangular(Vector::Vector<float> const&) const;
template Vector::Vector<long double> Matrix<float>::solveLowerTriangular(Vector::Vector<double> const&) const;
template Vector::Vector<long double> Matrix<float>::solveLowerTriangular(Vector::Vector<long double> const&) const;

template Vector::Vector<long double> Matrix<double>::solveLowerTriangular(Vector::Vector<int> const&) const;
template Vector::Vector<long double> Matrix<double>::solveLowerTriangular(Vector::Vector<float> const&) const;
template Vector::Vector<long double> Matrix<double>::solveLowerTriangular(Vector::Vector<double> const&) const;
template Vector::Vector<long double> Matrix<double>::solveLowerTriangular(Vector::Vector<long double> const&) const;

template Vector::Vector<long double> Matrix<long double>::solveLowerTriangular(Vector::Vector<int> const&) const;
template Vector::Vector<long double> Matrix<long double>::solveLowerTriangular(Vector::Vector<float> const&) const;
template Vector::Vector<long double> Matrix<long double>::solveLowerTriangular(Vector::Vector<double> const&) const;
template Vector::Vector<long double> Matrix<long double>::solveLowerTriangular(Vector::Vector<long double> const&) const;

//Solve upper triangular
template Vector::Vector<long double> Matrix<int>::solveUpperTriangular(Vector::Vector<int> const&) const;
template Vector::Vector<long double> Matrix<int>::solveUpperTriangular(Vector::Vector<float> const&) const;
template Vector::Vector<long double> Matrix<int>::solveUpperTriangular(Vector::Vector<double> const&) const;
template Vector::Vector<long double> Matrix<int>::solveUpperTriangular(Vector::Vector<long double> const&) const;

template Vector::Vector<long double> Matrix<float>::solveUpperTriangular(Vector::Vector<int> const&) const;
template Vector::Vector<long double> Matrix<float>::solveUpperTriangular(Vector::Vector<float> const&) const;
template Vector::Vector<long double> Matrix<float>::solveUpperTriangular(Vector::Vector<double> const&) const;
template Vector::Vector<long double> Matrix<float>::solveUpperTriangular(Vector::Vector<long double> const&) const;

template Vector::Vector<long double> Matrix<double>::solveUpperTriangular(Vector::Vector<int> const&) const;
template Vector::Vector<long double> Matrix<double>::solveUpperTriangular(Vector::Vector<float> const&) const;
template Vector::Vector<long double> Matrix<double>::solveUpperTriangular(Vector::Vector<double> const&) const;
template Vector::Vector<long double> Matrix<double>::solveUpperTriangular(Vector::Vector<long double> const&) const;

template Vector::Vector<long double> Matrix<long double>::solveUpperTriangular(Vector::Vector<int> const&) const;
template Vector::Vector<long double> Matrix<long double>::solveUpperTriangular(Vector::Vector<float> const&) const;
template Vector::Vector<long double> Matrix<long double>::solveUpperTriangular(Vector::Vector<double> const&) const;
template Vector::Vector<long double> Matrix<long double>::solveUpperTriangular(Vector::Vector<long double> const&) const;

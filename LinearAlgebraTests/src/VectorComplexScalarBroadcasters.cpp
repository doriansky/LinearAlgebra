...
TEST_F(VectorComplexBroadcastersTests, Multiplication_BroadcastComplexScalars_To_IntVector)
{
    const auto intVector = Vector<int>({1,2,3});
    ...
    {
        const auto res = intVector * intComplexScalar;
        ASSERT_EQ(res[0], std::complex<int>(1,1));
        ASSERT_EQ(res[1], std::complex<int>(2,2));
        ASSERT_EQ(res[2], std::complex<int>(3,3));

        const auto resFloat = intVector * floatComplexScalar;
        ASSERT_NEAR(resFloat[0].real(), 1.1f, fepsilon);   ASSERT_NEAR(resFloat[0].imag(), 1.1f, fepsilon);
        ASSERT_NEAR(resFloat[1].real(), 2.2f, fepsilon);   ASSERT_NEAR(resFloat[1].imag(), 2.2f, fepsilon);
        ASSERT_NEAR(resFloat[2].real(), 3.3f, fepsilon);   ASSERT_NEAR(resFloat[2].imag(), 3.3f, fepsilon);

        const auto resDouble = intVector * doubleComplexScalar;
        ASSERT_NEAR(resDouble[0].real(), 1.1, epsilon);   ASSERT_NEAR(resDouble[0].imag(), 1.1, epsilon);
        ASSERT_NEAR(resDouble[1].real(), 2.2, epsilon);   ASSERT_NEAR(resDouble[1].imag(), 2.2, epsilon);
        ASSERT_NEAR(resDouble[2].real(), 3.3, epsilon);   ASSERT_NEAR(resDouble[2].imag(), 3.3, epsilon);

        const auto resLongDouble = intVector * longDoubleComplexScalar;
        ASSERT_NEAR(resLongDouble[0].real(), 1.1, epsilon);   ASSERT_NEAR(resLongDouble[0].imag(), 1.1, epsilon);
        ASSERT_NEAR(resLongDouble[1].real(), 2.2, epsilon);   ASSERT_NEAR(resLongDouble[1].imag(), 2.2, epsilon);
        ASSERT_NEAR(resLongDouble[2].real(), 3.3, epsilon);   ASSERT_NEAR(resLongDouble[2].imag(), 3.3, epsilon);
    }
...
TEST_F(VectorComplexBroadcastersTests, Multiplication_BroadcastScalars_To_ComplexIntVector)
{
    const auto complexIntVector = Vector<std::complex<int>>({{1,1},{2,2},{3,3}});
    ...
    const auto floatComplexScalar = std::complex<float>{1.1f,1.1f};
    const auto doubleComplexScalar = std::complex<double>{1.1,1.1};
    const auto longDoubleComplexScalar = std::complex<double>{1.1,1.13};

    {
        ...
        const auto resLongDouble = complexIntVector * longScalar;
        ASSERT_NEAR(resLongDouble[0].real(), 1.12, epsilon);   ASSERT_NEAR(resLongDouble[0].imag(), 1.12, epsilon);
        ASSERT_NEAR(resLongDouble[1].real(), 2.24, epsilon);   ASSERT_NEAR(resLongDouble[1].imag(), 2.24, epsilon);
        ASSERT_NEAR(resLongDouble[2].real(), 3.36, epsilon);   ASSERT_NEAR(resLongDouble[2].imag(), 3.36, epsilon);
    }

    {
        const auto res = complexIntVector * intComplexScalar;
        ASSERT_EQ(res[0], std::complex<int>(0,2));
        ASSERT_EQ(res[1], std::complex<int>(0,4));
        ASSERT_EQ(res[2], std::complex<int>(0,6));

        const auto resFloat = complexIntVector * floatComplexScalar;
        ASSERT_NEAR(resFloat[0].real(), 0.0f, fepsilon);   ASSERT_NEAR(resFloat[0].imag(), 2.2f, fepsilon);
        ASSERT_NEAR(resFloat[1].real(), 0.0f, fepsilon);   ASSERT_NEAR(resFloat[1].imag(), 4.4f, fepsilon);
        ASSERT_NEAR(resFloat[2].real(), 0.0f, fepsilon);   ASSERT_NEAR(resFloat[2].imag(), 6.6f, fepsilon);

        const auto resDouble = complexIntVector * doubleComplexScalar;
        ASSERT_NEAR(resDouble[0].real(), 0.0, epsilon);   ASSERT_NEAR(resDouble[0].imag(), 2.2, epsilon);
        ASSERT_NEAR(resDouble[1].real(), 0.0, epsilon);   ASSERT_NEAR(resDouble[1].imag(), 4.4, epsilon);
        ASSERT_NEAR(resDouble[2].real(), 0.0, epsilon);   ASSERT_NEAR(resDouble[2].imag(), 6.6, epsilon);

        const auto resLongDouble = complexIntVector * longDoubleComplexScalar;
        ASSERT_NEAR(resLongDouble[0].real(), -0.03, epsilon);   ASSERT_NEAR(resLongDouble[0].imag(), 2.23, epsilon);
        ASSERT_NEAR(resLongDouble[1].real(), -0.06, epsilon);   ASSERT_NEAR(resLongDouble[1].imag(), 4.46, epsilon);
        ASSERT_NEAR(resLongDouble[2].real(), -0.09, epsilon);   ASSERT_NEAR(resLongDouble[2].imag(), 6.69, epsilon);
    }
...
TEST_F(VectorComplexBroadcastersTests, Multiplication_BroadcastComplexScalars_To_FloatVector)
{
    const auto floatVector = Vector<float>({1.1f,2.2f,3.3f});
    ...
    {
        const auto res = floatVector * intComplexScalar;
        ASSERT_NEAR(res[0].real(), 1.1f, fepsilon);   ASSERT_NEAR(res[0].imag(), 1.1f, fepsilon);
        ASSERT_NEAR(res[1].real(), 2.2f, fepsilon);   ASSERT_NEAR(res[1].imag(), 2.2f, fepsilon);
        ASSERT_NEAR(res[2].real(), 3.3f, fepsilon);   ASSERT_NEAR(res[2].imag(), 3.3f, fepsilon);

        const auto resFloat = floatVector * floatComplexScalar;
        ASSERT_NEAR(resFloat[0].real(), 1.21f, fepsilon);   ASSERT_NEAR(resFloat[0].imag(), 1.21f, fepsilon);
        ASSERT_NEAR(resFloat[1].real(), 2.42f, fepsilon);   ASSERT_NEAR(resFloat[1].imag(), 2.42f, fepsilon);
        ASSERT_NEAR(resFloat[2].real(), 3.63f, fepsilon);   ASSERT_NEAR(resFloat[2].imag(), 3.63f, fepsilon);

        const auto resDouble = floatVector * doubleComplexScalar;
        ASSERT_NEAR(resDouble[0].real(), 1.21, fepsilon);   ASSERT_NEAR(resDouble[0].imag(), 1.21, fepsilon);
        ASSERT_NEAR(resDouble[1].real(), 2.42, fepsilon);   ASSERT_NEAR(resDouble[1].imag(), 2.42, fepsilon);
        ASSERT_NEAR(resDouble[2].real(), 3.63, fepsilon);   ASSERT_NEAR(resDouble[2].imag(), 3.63, fepsilon);

        const auto resLongDouble = floatVector * longDoubleComplexScalar;
        ASSERT_NEAR(resLongDouble[0].real(), 1.21, fepsilon);   ASSERT_NEAR(resLongDouble[0].imag(), 1.21, fepsilon);
        ASSERT_NEAR(resLongDouble[1].real(), 2.42, fepsilon);   ASSERT_NEAR(resLongDouble[1].imag(), 2.42, fepsilon);
        ASSERT_NEAR(resLongDouble[2].real(), 3.63, fepsilon);   ASSERT_NEAR(resLongDouble[2].imag(), 3.63, fepsilon);
    }
...
TEST_F(VectorComplexBroadcastersTests, Multiplication_BroadcastScalars_To_ComplexFloatVector)
{
    const auto complexFloatVector = Vector<std::complex<float>>({{1.1f,1.2f},{2.3f,2.4f},{3.5f,3.6f}});
    ...
    {
        const auto res = complexFloatVector * intScalar;
        ASSERT_NEAR(res[0].real(), 1.1f, fepsilon);   ASSERT_NEAR(res[0].imag(), 1.2f, fepsilon);
        ASSERT_NEAR(res[1].real(), 2.3f, fepsilon);   ASSERT_NEAR(res[1].imag(), 2.4f, fepsilon);
        ASSERT_NEAR(res[2].real(), 3.5f, fepsilon);   ASSERT_NEAR(res[2].imag(), 3.6f, fepsilon);

        const auto resFloat = complexFloatVector * floatScalar;
        ASSERT_NEAR(resFloat[0].real(), 1.21f, fepsilon);   ASSERT_NEAR(resFloat[0].imag(), 1.32f, fepsilon);
        ASSERT_NEAR(resFloat[1].real(), 2.53f, fepsilon);   ASSERT_NEAR(resFloat[1].imag(), 2.64f, fepsilon);
        ASSERT_NEAR(resFloat[2].real(), 3.85f, fepsilon);   ASSERT_NEAR(resFloat[2].imag(), 3.96f, fepsilon);

        const auto resDouble = complexFloatVector * doubleScalar;
        ASSERT_NEAR(resDouble[0].real(), 1.21, fepsilon);   ASSERT_NEAR(resDouble[0].imag(), 1.32, fepsilon);
        ASSERT_NEAR(resDouble[1].real(), 2.53, fepsilon);   ASSERT_NEAR(resDouble[1].imag(), 2.64, fepsilon);
        ASSERT_NEAR(resDouble[2].real(), 3.85, fepsilon);   ASSERT_NEAR(resDouble[2].imag(), 3.96, fepsilon);

        const auto resLongDouble = complexFloatVector * longScalar;
        ASSERT_NEAR(resLongDouble[0].real(), 1.232, fepsilon);   ASSERT_NEAR(resLongDouble[0].imag(), 1.344, fepsilon);
        ASSERT_NEAR(resLongDouble[1].real(), 2.576, fepsilon);   ASSERT_NEAR(resLongDouble[1].imag(), 2.688, fepsilon);
        ASSERT_NEAR(resLongDouble[2].real(), 3.92, fepsilon);   ASSERT_NEAR(resLongDouble[2].imag(), 4.032, fepsilon);
    }

    {
        const auto res = complexFloatVector * intComplexScalar;
        ASSERT_NEAR(res[0].real(), -0.1f, fepsilon);   ASSERT_NEAR(res[0].imag(), 2.3f, fepsilon);
        ASSERT_NEAR(res[1].real(), -0.1f, fepsilon);   ASSERT_NEAR(res[1].imag(), 4.7f, fepsilon);
        ASSERT_NEAR(res[2].real(), -0.1f, fepsilon);   ASSERT_NEAR(res[2].imag(), 7.1f, fepsilon);


        const auto resFloat = complexFloatVector * floatComplexScalar;
        ASSERT_NEAR(resFloat[0].real(), -0.11f, fepsilon);   ASSERT_NEAR(resFloat[0].imag(), 2.53f, fepsilon);
        ASSERT_NEAR(resFloat[1].real(), -0.11f, fepsilon);   ASSERT_NEAR(resFloat[1].imag(), 5.17f, fepsilon);
        ASSERT_NEAR(resFloat[2].real(), -0.11f, fepsilon);   ASSERT_NEAR(resFloat[2].imag(), 7.81f, fepsilon);

        const auto resDouble = complexFloatVector * doubleComplexScalar;
        ASSERT_NEAR(resDouble[0].real(), -0.11, fepsilon);   ASSERT_NEAR(resDouble[0].imag(), 2.53, fepsilon);
        ASSERT_NEAR(resDouble[1].real(), -0.11, fepsilon);   ASSERT_NEAR(resDouble[1].imag(), 5.17, fepsilon);
        ASSERT_NEAR(resDouble[2].real(), -0.11, fepsilon);   ASSERT_NEAR(resDouble[2].imag(), 7.81, fepsilon);

        const auto resLongDouble = complexFloatVector * longDoubleComplexScalar;
        ASSERT_NEAR(resLongDouble[0].real(), -0.134, fepsilon);   ASSERT_NEAR(resLongDouble[0].imag(), 2.552, fepsilon);
        ASSERT_NEAR(resLongDouble[1].real(), -0.158, fepsilon);   ASSERT_NEAR(resLongDouble[1].imag(), 5.216, fepsilon);
        ASSERT_NEAR(resLongDouble[2].real(), -0.182, fepsilon);   ASSERT_NEAR(resLongDouble[2].imag(), 7.88, fepsilon);
    }
...
TEST_F(VectorComplexBroadcastersTests, Multiplication_BroadcastComplexScalars_To_DoubleVector)
{
    const auto doubleVector = Vector<double>({1.1,2.2,3.3});
    ...
    {
        const auto res = doubleVector * intComplexScalar;
        ASSERT_NEAR(res[0].real(), 1.1, epsilon);   ASSERT_NEAR(res[0].imag(), 1.1, epsilon);
        ASSERT_NEAR(res[1].real(), 2.2, epsilon);   ASSERT_NEAR(res[1].imag(), 2.2, epsilon);
        ASSERT_NEAR(res[2].real(), 3.3, epsilon);   ASSERT_NEAR(res[2].imag(), 3.3, epsilon);

        const auto resFloat = doubleVector * floatComplexScalar;
        ASSERT_NEAR(resFloat[0].real(), 1.21, fepsilon);   ASSERT_NEAR(resFloat[0].imag(), 1.21, fepsilon);
        ASSERT_NEAR(resFloat[1].real(), 2.42, fepsilon);   ASSERT_NEAR(resFloat[1].imag(), 2.42, fepsilon);
        ASSERT_NEAR(resFloat[2].real(), 3.63, fepsilon);   ASSERT_NEAR(resFloat[2].imag(), 3.63, fepsilon);

        const auto resDouble = doubleVector * doubleComplexScalar;
        ASSERT_NEAR(resDouble[0].real(), 1.21, epsilon);   ASSERT_NEAR(resDouble[0].imag(), 1.21, epsilon);
        ASSERT_NEAR(resDouble[1].real(), 2.42, epsilon);   ASSERT_NEAR(resDouble[1].imag(), 2.42, epsilon);
        ASSERT_NEAR(resDouble[2].real(), 3.63, epsilon);   ASSERT_NEAR(resDouble[2].imag(), 3.63, epsilon);

        const auto resLongDouble = doubleVector * longDoubleComplexScalar;
        ASSERT_NEAR(resLongDouble[0].real(), 1.21, epsilon);   ASSERT_NEAR(resLongDouble[0].imag(), 1.21, epsilon);
        ASSERT_NEAR(resLongDouble[1].real(), 2.42, epsilon);   ASSERT_NEAR(resLongDouble[1].imag(), 2.42, epsilon);
        ASSERT_NEAR(resLongDouble[2].real(), 3.63, epsilon);   ASSERT_NEAR(resLongDouble[2].imag(), 3.63, epsilon);
    }
...
TEST_F(VectorComplexBroadcastersTests, Multiplication_BroadcastScalars_To_ComplexDoubleVector)
{
    const auto complexDoubleVector = Vector<std::complex<double>>({{1.1,1.2},{2.3,2.4},{3.5,3.6}});
    ...
    {
        const auto res = complexDoubleVector * intScalar;
        ASSERT_NEAR(res[0].real(), 1.1, epsilon);   ASSERT_NEAR(res[0].imag(), 1.2, epsilon);
        ASSERT_NEAR(res[1].real(), 2.3, epsilon);   ASSERT_NEAR(res[1].imag(), 2.4, epsilon);
        ASSERT_NEAR(res[2].real(), 3.5, epsilon);   ASSERT_NEAR(res[2].imag(), 3.6, epsilon);

        const auto resFloat = complexDoubleVector * floatScalar;
        ASSERT_NEAR(resFloat[0].real(), 1.21, fepsilon);   ASSERT_NEAR(resFloat[0].imag(), 1.32, fepsilon);
        ASSERT_NEAR(resFloat[1].real(), 2.53, fepsilon);   ASSERT_NEAR(resFloat[1].imag(), 2.64, fepsilon);
        ASSERT_NEAR(resFloat[2].real(), 3.85, fepsilon);   ASSERT_NEAR(resFloat[2].imag(), 3.96, fepsilon);

        const auto resDouble = complexDoubleVector * doubleScalar;
        ASSERT_NEAR(resDouble[0].real(), 1.21, epsilon);   ASSERT_NEAR(resDouble[0].imag(), 1.32, epsilon);
        ASSERT_NEAR(resDouble[1].real(), 2.53, epsilon);   ASSERT_NEAR(resDouble[1].imag(), 2.64, epsilon);
        ASSERT_NEAR(resDouble[2].real(), 3.85, epsilon);   ASSERT_NEAR(resDouble[2].imag(), 3.96, epsilon);

        const auto resLongDouble = complexDoubleVector * longScalar;
        ASSERT_NEAR(resLongDouble[0].real(), 1.232, epsilon);   ASSERT_NEAR(resLongDouble[0].imag(), 1.344, epsilon);
        ASSERT_NEAR(resLongDouble[1].real(), 2.576, epsilon);   ASSERT_NEAR(resLongDouble[1].imag(), 2.688, epsilon);
        ASSERT_NEAR(resLongDouble[2].real(), 3.92,  epsilon);   ASSERT_NEAR(resLongDouble[2].imag(), 4.032, epsilon);
    }

    {
        const auto res = complexDoubleVector * intComplexScalar;
        ASSERT_NEAR(res[0].real(), -0.1, epsilon);   ASSERT_NEAR(res[0].imag(), 2.3, epsilon);
        ASSERT_NEAR(res[1].real(), -0.1, epsilon);   ASSERT_NEAR(res[1].imag(), 4.7, epsilon);
        ASSERT_NEAR(res[2].real(), -0.1, epsilon);   ASSERT_NEAR(res[2].imag(), 7.1, epsilon);


        const auto resFloat = complexDoubleVector * floatComplexScalar;
        ASSERT_NEAR(resFloat[0].real(), -0.11, fepsilon);   ASSERT_NEAR(resFloat[0].imag(), 2.53, fepsilon);
        ASSERT_NEAR(resFloat[1].real(), -0.11, fepsilon);   ASSERT_NEAR(resFloat[1].imag(), 5.17, fepsilon);
        ASSERT_NEAR(resFloat[2].real(), -0.11, fepsilon);   ASSERT_NEAR(resFloat[2].imag(), 7.81, fepsilon);

        const auto resDouble = complexDoubleVector * doubleComplexScalar;
        ASSERT_NEAR(resDouble[0].real(), -0.11, epsilon);   ASSERT_NEAR(resDouble[0].imag(), 2.53, epsilon);
        ASSERT_NEAR(resDouble[1].real(), -0.11, epsilon);   ASSERT_NEAR(resDouble[1].imag(), 5.17, epsilon);
        ASSERT_NEAR(resDouble[2].real(), -0.11, epsilon);   ASSERT_NEAR(resDouble[2].imag(), 7.81, epsilon);

        const auto resLongDouble = complexDoubleVector * longDoubleComplexScalar;
        ASSERT_NEAR(resLongDouble[0].real(), -0.134, epsilon);   ASSERT_NEAR(resLongDouble[0].imag(), 2.552, epsilon);
        ASSERT_NEAR(resLongDouble[1].real(), -0.158, epsilon);   ASSERT_NEAR(resLongDouble[1].imag(), 5.216, epsilon);
        ASSERT_NEAR(resLongDouble[2].real(), -0.182, epsilon);   ASSERT_NEAR(resLongDouble[2].imag(), 7.88,  epsilon);
    }
...
TEST_F(VectorComplexBroadcastersTests, Multiplication_BroadcastComplexScalars_To_LongDoubleVector)
{
    const auto doubleVector = Vector<long double>({1.1,2.2,3.3});
...
TEST_F(VectorComplexBroadcastersTests, Multiplication_BroadcastScalars_To_ComplexLongDoubleVector)
{
    const auto complexDoubleVector = Vector<std::complex<long double>>({{1.1,1.2},{2.3,2.4},{3.5,3.6}});
...
TEST_F(VectorComplexBroadcastersTests, Multiplication_InPlace_Broadcaster)
{
    auto complexIntVector = Vector<std::complex<int>>({{1, 1},{2 ,2},{3, 3}});
    auto complexFloatVector = Vector<std::complex<float>>({{1.1f, 1.2f},{2.3f, 2.4f},{3.5f, 3.6f}});
    auto complexDoubleVector = Vector<std::complex<double>>({{1.1,1.2},{2.3,2.4},{3.5,3.6}});
    ...
    complexIntVector *= intComplexScalar;
    ASSERT_EQ(complexIntVector[0], std::complex<int>(0,2));
    ASSERT_EQ(complexIntVector[1], std::complex<int>(0,4));
    ASSERT_EQ(complexIntVector[2], std::complex<int>(0,6));

    complexFloatVector *= floatComplexScalar;
    ASSERT_NEAR(complexFloatVector[0].real(), -0.11f, fepsilon);   ASSERT_NEAR(complexFloatVector[0].imag(), 2.53f, fepsilon);
    ASSERT_NEAR(complexFloatVector[1].real(), -0.11f, fepsilon);   ASSERT_NEAR(complexFloatVector[1].imag(), 5.17f, fepsilon);
    ASSERT_NEAR(complexFloatVector[2].real(), -0.11f, fepsilon);   ASSERT_NEAR(complexFloatVector[2].imag(), 7.81f, fepsilon);

    complexDoubleVector *= doubleComplexScalar;
    ASSERT_NEAR(complexDoubleVector[0].real(), -0.11, epsilon);   ASSERT_NEAR(complexDoubleVector[0].imag(), 2.53, epsilon);
    ASSERT_NEAR(complexDoubleVector[1].real(), -0.11, epsilon);   ASSERT_NEAR(complexDoubleVector[1].imag(), 5.17, epsilon);
    ASSERT_NEAR(complexDoubleVector[2].real(), -0.11, epsilon);   ASSERT_NEAR(complexDoubleVector[2].imag(), 7.81, epsilon);

    complexLongDoubleVector *= longDoubleComplexScalar;
    ASSERT_NEAR(complexLongDoubleVector[0].real(), -0.134, epsilon);   ASSERT_NEAR(complexLongDoubleVector[0].imag(), 2.552, epsilon);
    ASSERT_NEAR(complexLongDoubleVector[1].real(), -0.158, epsilon);   ASSERT_NEAR(complexLongDoubleVector[1].imag(), 5.216, epsilon);
    ASSERT_NEAR(complexLongDoubleVector[2].real(), -0.182, epsilon);   ASSERT_NEAR(complexLongDoubleVector[2].imag(), 7.88,  epsilon);
}
...
TEST_F(MatrixInverseTests_HilbertTests, Inverse_Hilbert_3x3)
{
    ...
    ASSERT_NEAR(inv(0,0), 9, epsilon);      ASSERT_NEAR(inv(0,1), -36, epsilon);    ASSERT_NEAR(inv(0,2), 30, epsilon);
    ASSERT_NEAR(inv(1,0), -36, epsilon);    ASSERT_NEAR(inv(1,1), 192, epsilon);    ASSERT_NEAR(inv(1,2), -180, epsilon);
    ASSERT_NEAR(inv(2,0), 30, epsilon);     ASSERT_NEAR(inv(2,1), -180, epsilon);   ASSERT_NEAR(inv(2,2), 180, epsilon);
...
TEST_F(MatrixInverseTests_HilbertTests, Inverse_Hilbert_4x4)
{
    ...
    ASSERT_NEAR(inv(0,0), 16, epsilon); ASSERT_NEAR(inv(0,1), -120, epsilon);       ASSERT_NEAR(inv(0,2), 240, epsilon);      ASSERT_NEAR(inv(0,3), -140, epsilon);
    ASSERT_NEAR(inv(1,0), -120, epsilon);   ASSERT_NEAR(inv(1,1), 1200, epsilon);   ASSERT_NEAR(inv(1,2), -2700, epsilon);    ASSERT_NEAR(inv(1,3), 1680, epsilon);
    ASSERT_NEAR(inv(2,0), 240, epsilon);    ASSERT_NEAR(inv(2,1), -2700, epsilon);  ASSERT_NEAR(inv(2,2), 6480, epsilon);     ASSERT_NEAR(inv(2,3), -4200, epsilon);
    ASSERT_NEAR(inv(3,0), -140, epsilon);   ASSERT_NEAR(inv(3,1), 1680, epsilon);   ASSERT_NEAR(inv(3,2), -4200, epsilon);    ASSERT_NEAR(inv(3,3), 2800, epsilon);
...
TEST_F(MatrixInverseTests_HilbertTests, Inverse_Hilbert_5x5)
{
    ...
    ASSERT_EQ(inv.rows(), 5); ASSERT_EQ(inv.cols(), 5);
    ASSERT_NEAR(inv(0,0), 25, epsilon);     ASSERT_NEAR(inv(0,1), -300, epsilon);   ASSERT_NEAR(inv(0,2), 1050, epsilon);       ASSERT_NEAR(inv(0,3), -1400, epsilon);      ASSERT_NEAR(inv(0,4), 630, epsilon);
    ASSERT_NEAR(inv(1,0), -300, epsilon);   ASSERT_NEAR(inv(1,1), 4800, epsilon);   ASSERT_NEAR(inv(1,2), -18900, epsilon);     ASSERT_NEAR(inv(1,3), 26880, epsilon);      ASSERT_NEAR(inv(1,4), -12600, epsilon);
    ASSERT_NEAR(inv(2,0), 1050, epsilon);   ASSERT_NEAR(inv(2,1), -18900, epsilon); ASSERT_NEAR(inv(2,2), 79380, epsilon);      ASSERT_NEAR(inv(2,3), -117600, epsilon);    ASSERT_NEAR(inv(2,4), 56700, epsilon);
    ASSERT_NEAR(inv(3,0), -1400, epsilon);  ASSERT_NEAR(inv(3,1), 26880, epsilon);  ASSERT_NEAR(inv(3,2), -117600, epsilon);    ASSERT_NEAR(inv(3,3), 179200, epsilon);     ASSERT_NEAR(inv(3,4), -88200, epsilon);
    ASSERT_NEAR(inv(4,0), 630, epsilon);    ASSERT_NEAR(inv(4,1), -12600, epsilon); ASSERT_NEAR(inv(4,2), 56700, epsilon);      ASSERT_NEAR(inv(4,3), -88200, epsilon);     ASSERT_NEAR(inv(4,4), 44100, epsilon);
